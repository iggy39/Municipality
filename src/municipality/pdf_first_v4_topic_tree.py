...
V4_ROOT_TOPICS: tuple[dict[str, Any], ...] = (
    ...
    {"root_topic_id": "root_religious_services", "root_label_he": "דת ושירותי דת", "keywords": ["דת", "דתית", "שירותי דת", "מועצה דתית", "מועצות דתיות", "בית כנסת", "מקווה", "מקווה טהרה", "רב", "הרבצת תורה"]},
...
CURATED_V4_CHILD_TOPICS: tuple[dict[str, Any], ...] = (
    ...
    {"root_topic_id": "root_infrastructure_environment", "child_label_he": "מערכות מידע ותקשורת ציבורית", "aliases_he": ["לוחות פרסום אלקטרוניים", "לוח מודעות אלקטרוני", "לוחות מודעות אלקטרוניים"]},
    ...
    {"root_topic_id": "root_religious_services", "child_label_he": "מועצה דתית", "aliases_he": ["מינוי מועצה דתית", "מועצות דתיות", "מינויים למועצות דתיות"]},
